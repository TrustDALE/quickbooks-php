 ...
 */
define('QUICKBOOKS_OBJECT_DELETEDLISTS', 'ListDeleted');
 ...
 */
define('QUICKBOOKS_OBJECT_DELETEDTXN', 'TxnDeleted');
 ...
 * DELETEDTXN Aliases
 */
define('QUICKBOOKS_OBJECT_TXNDELETED', QUICKBOOKS_OBJECT_DELETEDTXN);
define('QUICKBOOKS_QUERY_DELETEDTRANSACTIONS', QUICKBOOKS_QUERY_DELETEDTXNS);
define('QUICKBOOKS_QUERY_TXNDELETED', QUICKBOOKS_QUERY_DELETEDTXNS);

define('QUICKBOOKS_OBJECT_GENERALDETAILREPORT', 'GeneralDetailReport');
define('QUICKBOOKS_QUERY_GENERALDETAILREPORT', 'GeneralDetailReportQuery');

define('QUICKBOOKS_OBJECT_GENERALSUMMARYREPORT', 'GeneralSummaryReport');
define('QUICKBOOKS_QUERY_GENERALSUMMARYREPORT', 'GeneralSummaryReportQuery');
